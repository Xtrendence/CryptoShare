...
export default function Item({ info, theme, settings, showPopup, hidePopup }: any) {
	...
	return (
		<TouchableOpacity style={[styles.card, styles[`card${theme}`], styles[`card${Utils.capitalizeFirstLetter(info.transactionCategory)}`]]}>
			<View>
				<View style={styles.row}>
					<Text style={[styles.text, styles[`text${theme}`], { backgroundColor:Colors[theme].accentThird }]}>{date}</Text>
				</View>
				<View style={styles.row}>
					<Text style={[styles.text, styles[`text${theme}`], { backgroundColor:Colors[theme].accentFirst }]}>{Utils.capitalizeFirstLetter(info.transactionCategory)}</Text>
				</View>
				<View style={styles.row}>
