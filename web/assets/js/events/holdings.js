...
buttonHoldingsAddCryptoAsset.addEventListener("click", () => {
	try {
		if(getSettingsChoices().transactionsAffectHoldings === "disabled") {
			let html = `<input class="uppercase" id="popup-input-symbol-crypto" type="text" placeholder="Coin Symbol..." spellcheck="false"><input id="popup-input-amount-crypto" type="number" placeholder="Amount..." spellcheck="false">`;
...
buttonHoldingsAddStockAsset.addEventListener("click", () => {
	try {
		if(getSettingsChoices().transactionsAffectHoldings === "disabled") {
			let html = `<input class="uppercase" id="popup-input-symbol-stock" type="text" placeholder="Stock Symbol..." spellcheck="false"><input id="popup-input-amount-stock" type="number" placeholder="Amount..." spellcheck="false">`;
